import 'dart:convert';
import 'package:apptienda_mysql/pages/powerPage.dart';
import 'package:apptienda_mysql/pages/vendedoresPage.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        routes: <String, WidgetBuilder>{
          '/powerPage': (BuildContext context) => new PowerPage(),
          '/vendedoresPage': (BuildContext context) => new VendedoresPage(),
